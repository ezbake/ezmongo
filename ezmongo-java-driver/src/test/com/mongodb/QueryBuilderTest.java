...
public class QueryBuilderTest extends TestCase {
    ...
    public QueryBuilderTest() throws EzConfigurationLoaderException {
        if (Mongo.isClientModeEnabled()){
            _testDB = cleanupMongo.getDB(mongoConfigurationHelper.getMongoDBDatabaseName());
        } else {
    ...
    @Test
    @Ignore // this is an invalid test, as we will require client to use GeoJSON format, not legacy coordinate point. This is necessary for agg pipeline
