...
class OutMessage extends BasicBSONEncoder implements Serializable {
    ...
    private transient final Mongo _mongo;
    private transient final DBCollection _collection;
    private transient PoolOutputBuffer _buffer;
