 ...
 * @dochub gridfs
 */
public class GridFS implements Serializable {
    ...
    protected GridFSDBFile _fix( Object o ){
        ...
        if (Mongo.isClientModeEnabled()) {
            GridFSDBFile tmp = new GridFSDBFile();
     ...
     */
    @Deprecated
    protected transient final DB _db;
     ...
     */
    @Deprecated
    protected transient final DBCollection _filesCollection;

    /**
     * @deprecated Please use {@link #getChunksCollection()} for access.
     */
    @Deprecated
    protected transient final DBCollection _chunkCollection;
