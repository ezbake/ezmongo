 ...
 */
public class GridFSInputFile extends GridFSFile implements Serializable {
    ...
    private transient final InputStream _in;
    ...
    private transient OutputStream _outputStream = null;
