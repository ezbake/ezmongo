...
public class DefaultDBEncoder extends BasicBSONEncoder implements DBEncoder, Serializable {
    ...
    static class DefaultFactory implements DBEncoderFactory, Serializable {
        @Override
